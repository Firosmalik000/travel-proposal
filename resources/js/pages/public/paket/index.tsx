            ...
            <MotionSection className="mx-auto w-full max-w-6xl px-4 pt-6 pb-8 sm:px-6">
                <div className="rounded-[32px] border border-border bg-card/90 px-5 py-7 shadow-lg sm:rounded-[36px] sm:px-6 sm:py-8">
                    ...
                    <p className="mt-2 text-muted-foreground">
                        {localize(paketPage?.excerpt, locale, t.description)}
                    </p>
                </div>
            </MotionSection>

            <MotionSection className="mx-auto w-full max-w-6xl px-4 pb-14 sm:px-6">
                <MotionCard className="grid gap-4 rounded-3xl border border-border bg-card/90 p-4 shadow-sm sm:grid-cols-2 sm:p-6 lg:grid-cols-3">
                    <FilterSelect
                    ...
                    <FilterSelect
                        ...
                        allLabel={t.filters.all}
                    />
                    <label className="text-xs font-semibold tracking-[0.2em] text-muted-foreground uppercase">
                        {t.filters.budget}
                        <input
                ...
                <MotionCard className="mt-4 flex flex-col gap-3 rounded-2xl border border-border bg-card/80 px-4 py-3 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
                    <p>
                        {t.summary.showing}{' '}
                ...
                {filteredPackages.length === 0 ? (
                    <MotionCard className="mt-8 rounded-3xl border border-dashed border-border bg-card/70 px-6 py-10 text-center shadow-sm">
                    ...
                    <MotionGroup className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">

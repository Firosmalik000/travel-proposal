...
class StorePackageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'content.gallery_positions' => ['nullable', 'array'],
            'content.gallery_positions.*' => ['array'],
            'content.gallery_positions.*.x' => ['required', 'numeric', 'between:-1000,1000'],
            'content.gallery_positions.*.y' => ['required', 'numeric', 'between:-1000,1000'],
            'content.gallery_positions.*.scale' => ['required', 'numeric', 'between:0.25,3'],
            'content.gallery_positions.*.version' => ['nullable', 'integer', Rule::in([2, 3])],
            'content.gallery_positions.*.frameScale' => ['nullable', 'numeric', 'between:0.4,1'],
            ...
            'content.hpp_estimate.operational_costs.foc.count' => ['nullable', 'integer', 'min:0', 'max:100'],
            ...
            'content.hpp_estimate.operational_costs.photographer.currency' => ['nullable', 'string', 'size:3'],
            ...
            'content.hpp_estimate.operational_costs.tour_leader.currency' => ['nullable', 'string', 'size:3'],

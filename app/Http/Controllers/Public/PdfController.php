...
class PdfController extends Controller
{
    ...
    private function brandingForPdf(): array
    {
        ...
        $logoDataUri = $this->logoDataUriFromSeoOrBranding(
            seo: SeoController::getPublicSettings(),
            brandingLogoPath: (string) ($overrides['logo_path'] ?? $defaults['logo_path']),
        );
    ...
    private function logoDataUriFromSeoOrBranding(array $seo, string $brandingLogoPath): ?string
    {
        ...
        // Last attempt: if SEO has URL but no path, try to resolve it against public/.
        if ($seoLogoUrl !== '') {

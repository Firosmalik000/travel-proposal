...
class CustomUmrohRequestController extends Controller
{
    public function __construct(
        private readonly CustomUmrohRequestNotifier $customUmrohRequestNotifier,
    ...
    public function store(StoreCustomUmrohRequestRequest $request): RedirectResponse
    {
        ...
        $customUmrohRequest = DB::transaction(function () use ($payload, $requestCode): CustomUmrohRequest {
            ...
            return CustomUmrohRequest::query()->create([
